...
private ChargingStation createStation(String suffix) {
    ...
    private Car createCar() {
        Car car = new Car(
            null, "Tesla", "Tesla", "Model 3", 2022, "AB-13-19",
            75.0, 30.0, 10000.0, 15.0
        );
    ...
    private Driver createDriver() {
        Driver driver = new Driver(null, UUID.randomUUID().toString() + "@example.com", "pass", "Driver", true);
    ...
    void testFindByChargingPointAndEndTimeIsNull() {
        ...
        Optional<ChargingSession> result = chargingSessionRepository.findByChargingPointAndEndTimeIsNull(point);
