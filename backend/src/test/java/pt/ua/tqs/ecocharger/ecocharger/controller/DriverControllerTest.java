...
public class DriverControllerTest {
    ...
    public void testUpdateDriver() throws Exception {
        ...
        when(driverService.updateDriver(1L, updatedDriver)).thenReturn(updatedDriver);
        ...
        mockMvc.perform(put("/api/v1/driver/1")
                ...
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(jsonPath("$.email").value("johnfantastic@example.com"));
    }
    ...
    public void testUpdateDriverNotFound() throws Exception {
        Driver updatedDriver = new Driver(null, "johnfantastic@example.com", "newpassword", "John Fantastic", true);
        when(driverService.updateDriver(6L, updatedDriver)).thenThrow(new NotFoundException("Driver not found"));
