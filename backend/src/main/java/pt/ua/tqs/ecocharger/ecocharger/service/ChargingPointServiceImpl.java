...
public class ChargingPointServiceImpl implements ChargingPointService {
    ...
    public ChargingPoint createPoint(ChargingPoint point, ChargingStation station) {
        Optional<List<ChargingPoint>> points = chargingPointRepository.findByChargingStationId(station.getId());
        if (points.isPresent()) {
    ...
    public List<ChargingPoint> getAvailablePoints( ChargingStation station) {
        Optional<List<ChargingPoint>> points = chargingPointRepository.findAvailablePointsByChargingStation(station);
    ...
    public List<ChargingPoint> getPointsByStationId(Long stationId) {
        Optional<List<ChargingPoint>> points = chargingPointRepository.findByChargingStationId(stationId);
